...
3. **Gestió de bancs**: crear/editar/eliminar. Un banc és opcional a cada despesa (per exemple, pagaments en efectiu no en tenen); si s'elimina un banc, les despeses que el tenien assignat el perden però no s'esborren.
4. **Pressupost anual**: import previst per categoria/subcategoria i mes (o per any, a decidir).
